...
public class RedisService {
	...
	public  void setList(String key , List<?> list , Class<?> type)throws Exception{
		if(list!=null){
			String value = ObjectsTranscoder.serializationList(list, type);
			this.set(key, value);
		} 
	}
	...
	public List getList(String key){
		String value = this.get(key);
		if(value!=null&&!CommonUtil.isEmpty(value)){
